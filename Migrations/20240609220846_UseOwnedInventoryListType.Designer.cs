...
namespace InventoryApplication.Migrations
{
    ...
    [Migration("20240609220846_UseOwnedInventoryListType")]
    partial class UseOwnedInventoryListType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InventoryApplication.Models.InventoryTransfer", b =>
                {
                    ...
                    b.OwnsMany("InventoryApplication.Models.InventoryTransferList", "Inventory", b1 =>
                        {
                            ...
                            b1.ToTable("inventory_transfer_list");
